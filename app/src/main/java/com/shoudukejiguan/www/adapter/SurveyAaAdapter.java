...
public class SurveyAaAdapter extends RecyclerView.Adapter<SurveyAaAdapter.ViewHolder> {
    private List<Survey.Question> urlList;
    private Map<Integer, String> map;
    private Map<Integer, Map<Integer, String>> mapAll;
    private int positionAll;

    public SurveyAaAdapter(List<Survey.Question> urlList, Map<Integer, Map<Integer, String>> mapAll, int position) {
